...
const AdminTools = ({ token })=>{
    ...
    const handleAdminReset = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/auth/admin-reset-password`, {
        ...
        "DashboardPage.useEffect": ()=>{
            const checkConnection = {
                "DashboardPage.useEffect.checkConnection": async ()=>{
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/beds`, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
...
const HospitalDiscovery = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HospitalDiscovery.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "https://nbs-backend.onrender.com/api/v1")}/api/v1/public/hospitals`).then({
    ...
    const handleSelect = async (id)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "https://nbs-backend.onrender.com/api/v1")}/api/v1/public/hospitals/${id}/availability`);
            ...
            hospitals.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            "Checking: ",
                            ("TURBOPACK compile-time value", "https://nbs-backend.onrender.com/api/v1")
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/components/HospitalDiscovery.tsx",
                        lineNumber: 56,
...
//# sourceMappingURL=src_19ebc51d._.js.map