...
const BedCard = ({ bedData, onStatusChange, token, userRole })=>{
        ...
        "BedCard.useEffect": ()=>{
            ...
            const fetchHistory = {
                "BedCard.useEffect.fetchHistory": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/beds/${bedId}/history`, {
                            headers: {
    ...
    const handleDelete = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete(`${API_BASE_URL}/beds/${bedId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
const TransferRequestList = ()=>{
    ...
    const fetchBeds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransferRequestList.useCallback[fetchBeds]": async ()=>{
            const token = localStorage.getItem('authToken');
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/beds`, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const fetchRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransferRequestList.useCallback[fetchRequests]": async ()=>{
            ...
            if (!token) return;
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`${API_BASE_URL}/transfers`, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
    ...
    const handleAction = async (id, action)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].patch(`${API_BASE_URL}/transfers/${id}`, {
                new_status: action,
...
const HospitalDiscovery = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            hospitals.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-8 text-center border-2 border-dashed rounded-xl text-gray-400",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "No hospitals found or connecting to server..."
                    }, void 0, false, {
                        fileName: "[project]/src/components/HospitalDiscovery.tsx",
                        lineNumber: 56,
                        columnNumber: 5
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            "Checking: ",
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosConfig$2e$js__$5b$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]
                        ]
                    }, void 0, true, {
                        fileName: "[project]/src/components/HospitalDiscovery.tsx",
                        lineNumber: 57,
            ...
            hospitals.map((hospital)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `px-3 py-1 rounded-full text-sm font-bold ${hospital.available_beds > 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`,
                                    children: [
                        ...
                        activeHospital === hospital.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-4 bg-gray-50 border-t grid grid-cols-1 sm:grid-cols-2 gap-3",
...
_s(HospitalDiscovery, "hpq3uQOJeT0TGCBHPMqXaA6KxiA=");
...
//# sourceMappingURL=src_34b83e65._.js.map